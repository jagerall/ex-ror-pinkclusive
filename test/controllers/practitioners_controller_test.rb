...
class PractitionersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create practitioner" do
    assert_difference("Practitioner.count") do
      post practitioners_url, params: { practitioner: { address: @practitioner.address, city: @practitioner.city, job: @practitioner.job, name: @practitioner.name, phone: @practitioner.phone, surname: @practitioner.surname } }
    end
  ...
  test "should update practitioner" do
    patch practitioner_url(@practitioner), params: { practitioner: { address: @practitioner.address, city: @practitioner.city, job: @practitioner.job, name: @practitioner.name, phone: @practitioner.phone, surname: @practitioner.surname } }
